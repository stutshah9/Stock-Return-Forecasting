...
def _predict_interval_confidence_scaled_naive(
    ...
    mu = _point_prediction_for_method(output, "normalized_conformal_modality")
...
def _selective_metric_rows(
    ...
    for min_score in min_scores:
        ...
        if not kept_indices:
            rows.append(
                {
                    "method": "normalized_conformal_modality_selective",
        ...
        mu_values = [
            _point_prediction_for_method(output, "normalized_conformal_modality")
...
def evaluate(config_path: str) -> None:
    ...
    interval_scales = _fit_interval_scales(
        modes=["adaptive", "normalized_modality"],
        coverage_levels=coverage_levels,
    ...
    for method, mode, active_predictor in evaluation_specs:
        ...
        if include_selective_analysis and method == "normalized_conformal_modality":
